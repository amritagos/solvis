...
def test_plotter_simple():
    ...
    pl_inter.add_single_atom_as_sphere([0,0,0], color="black", radius=0.1, actor_name="point0")
    # Test the position
    np.testing.assert_array_equal([0,0,0], pl_inter.plotter.renderer.actors["point0"].position)
